...
console.log(chalk.bold.hex("#00ffff").bold("[ LegendSam (MTX) ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`Senpai Sam`, '[ Legend Sam (MTX) ]');
        logger('Hey, thank you for using this Bot', '[ Legend Sam (MTX) ]');
        logger("Fixed by Senpai Sam", '[ LegendSam (MTX) ]');
